...
<head>
    ...
    <title> Digital Passport Photos for Online Application UK – Hounslow </title>
    <meta name="description" content="Need digital passport photos for online application in UK. Hounslow, a best place to print digital passport photos at the ease from home near London, UK." />
    <link rel="canonical" href="https://hounslowpassportphotoshop.co.uk/" />
    <link href="css/bootstrap.min.css" rel="stylesheet">
    <link href="css/cropper.css" rel="stylesheet">
    <link href="css/style.css?ver=<?php echo time();?>" rel="stylesheet">
    <link href="css/select-option.css" rel="stylesheet" type="text/css">
    ...
    <script src="js/jquery-select-option.js"></script>
    <script type="application/ld+json">
         { "@context": "https://schema.org",
         "@type": "Organization",
         "name": "Hounslow Passport Photo",
         "legalName" : "Hounslow Passport Photo",
         "alternateName": "Passport Digital ID Photo",
         "url": "https://hounslowpassportphotoshop.co.uk/",
         "logo": "https://hounslowpassportphotoshop.co.uk/images/logo3.png",
         "foundingDate": "2022",
         "founders": [
         {
         "@type": "Person",
         ...
         "address": {
         "@type": "PostalAddress",
         "streetAddress": "756F Bath Rd Cranford",
         ...
         "telephone": "07553949353",
         "email": "contact@hounslowpassportphotoshop.co.uk"
         },
          "aggregateRating": {
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-9S9Z5XVNVQ"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'G-9S9Z5XVNVQ');
        </script>

        <!-- Global site tag (gtag.js) - Google Analytics -->
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-234769832-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-234769832-1');
        </script>
    ...
    <div class="whole">
        <div class="banner_bg">
            <div class="banner_left">
                <header>
                    <div class="header-bg">
                        <div class="header-left">
                            <div class="desktop">
                                <div class="logo">
                                    <a class="site-logo_home" href="https://hounslowpassportphotoshop.co.uk/">
                                    <img src="images/logo3.png" alt="hounslow-passport-photoshop-uk">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <section>
                    <div class="your-digital-id">
                        <img src="images/apply-for-uk.png" alt="hounslow-passport-photoshop-digital-passport-photo-service">
                    </div>
                    <div class="passport_img">
                        <img src="images/passport_img.png" alt="hounslow-passport-photoshop-passport-photo-online-application" />
                    </div>
                </section>
            </div>
            <div class="banner_right">
                <div class="passport-bg">
                    ...
                    <div class="address_info">
                        <div class="adddress_info_list">
                            <img src="images/location_icon.png" alt="hounslow-passport-photoshop-location">
                            <span>756F bath Rd Cranford Middlesex TW5 TY Hounslow</span>
                        </div>
                        <div class="adddress_info_list">
                            <img src="images/mail_icon2.png" alt="hounslow-passport-photoshop-mail">
                            <span><a
                                    href="mailto:contact@hounslowpassportphotoshop.co.uk">contact@hounslowpassportphotoshop.co.uk</a></span>
                        </div>
                        <div class="adddress_info_list">
                            <img src="images/phone_icon.png" alt="hounslow-passport-photoshop-phone">
                            <span><a href="tel:02087593688">02087593688</a> , <a
                                    href="tel:07553949353">07553949353</a></span>
                        </div>
                        <div class="adddress_info_list">
                            <img src="images/globe_icon2.png" alt="hounslow-passport-photoshop-globe">
                            <span><a
                ...
                <div class="british-passport">
                    <img src="images/passpot_copy.png" alt="hounslow-passport-photoshop-online-digital-passport-photo">
                </div>
            </div>
        </div>
      ...
      <img src="images/banner.jpg" alt="Banner" />
        ...
        <section class="inner-box-1">
            <div class="container">
                <h1> Digital Passport Photo For Online Application UK </h1>
      ...
      if (isset($_REQUEST['method'])) {
        ...
        $ogimg = '<img src="' . $_SESSION['ogPhoto'] . '" alt="photo" width="400">';
        $rmimg = '<img src="' . $_SESSION['rmPhoto'] . '" alt="photo" width="400">';
        ...
        $message = "<html>
                                ...
                                <body>
                                <img style=' display: block; margin: 0 auto;' src='https://hounslowpassportphotoshop.co.uk/images/logo3.png' alt='hounslow-passport-photoshop-uk'>
                                <p> Please Review Your Submitted Detail </p>
       ...
       // $mail->AddCC('contact@hounslowpassportphotoshop.co.uk');
        ...
        if(isset($_REQUEST['method']) && $_REQUEST['method'] == 'stripe' && $_POST["stripeToken"]){ 
          ...
          \Stripe\Stripe::setApiKey("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");
          $error = '';
          $success = '';
          ...
          if($api_error){ ?>
            ...
            <div class="modal fade" id="paymentsucessmodel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="exampleModalLabel">Payment Status Failed</h5>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                                 <span class="payment-success">Your payment was failed.</span>
                              </div>  
                    </div>
                  </div>
                </div>
          ...
          ?>
            ...
            <form action="https://www.paypal.com/cgi-bin/webscr" id="paypal_form" method="post">
                ...
                <input type="hidden" name="business" value="canvaswallartprint@gmail.com">
                <INPUT TYPE="hidden" NAME="currency_code" value="GBP">
                <INPUT TYPE="hidden" NAME="return"
                    value="https://hounslowpassportphotoshop.co.uk/?message=paymentsucess&&price=<?php echo $_POST['delivery_option'];?>&&email=<?php echo $_POST['email'];?>&&paymentmethods=Paypal&&address2=<?php echo $_POST['address2'];?>&&address3=<?php echo $_POST['address3'];?>&&DocTypeActual=<?php echo $_POST['DocTypeActual'];?>">
             ...
             $transid = $_GET['PayerID'];
                if($transid){
                  ...
                  $message = "<html>
                                ...
                                <body>
                                <img style=' display: block; margin: 0 auto;' src='https://hounslowpassportphotoshop.co.uk/images/logo3.png' alt='hounslow-passport-photoshop-uk'>
                                <p> Thank you for your order from https://hounslowpassportphotoshop.co.uk/ we have received your photo. We will make sure you have the approved passport photo in 8 hours . </p>
                                <p> Payment  Status : ". $orderstatus . "</p>
                                <p> Payment Method : " . $_GET['paymentmethods'] . "</p>
                                <p> Transaction ID : " . $transid . "</p>
                                <p> Your Delivery Price is : £" . $_GET['price'] . "</p>
                                </body>
                                </html>";
                $subject = 'New Photo Uploaded';
        ...
        ?>
             <div class="modal fade" id="paymentsucessmodel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Payment Status Paid </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                        <span class="payment-success">Transaction ID :- <?php echo $chargeid?></span>
       ...
       <script>
            ...
            <section class="inner-box-1 step1">
                ...
                <form name="message" method="post" id="payment-form" enctype="multipart/form-data">
                    <div class="help-bg-home">
                        <div class="form-group">
                            ...
                            <select name="delivery_option" required class="form-control selectize"
                                onChange="setChageVal(this.value);"><option value="4.99">British Passport Photo code (Uk Only) 
                                    For online application £4.99 (Uk)
                                    Email delivery 8 hours
                                </option>    
                                <option value="5.99">Six printed passport photos £5.99 (Uk Only) 
                                    Home delivery
                                </option>
                                <option value="4.99">Any other country passport photos - Please select your country
                                    Digital photos £4.99
                                    Email delivery 8 hours
                                </option>
                                </optgroup>
                        ...
                        <div class="help-left">
                            <div class="cropper" style="max-width:405px;max-height:420px">
                                ...
                                <div id="ss" class="imgdiv">
                                    <img id="blah" src="images/blankimg.png" alt="hounslow-passport-photoshop-passport-photo-online-uk" />
                                </div>
                ...
                <div class="input-group mb-3 display_block" style="margin-top: 5px;">
                  ...
                  <label for="send_to_mail" class="radiobtn">Passport digital photo send to email <span class="price">£7.99</span>(Worldwide)</label><br>
                            ...
                            <div class="input-group mb-3 display_block payment_method_list" style="margin-top: 5px;">
                                <div class="form-check">
                                    <input type="radio" id="stripe_method" name="method" value="stripe" checked
                                        required>
                                    <label for="stripe_method" class="radiobtn">Credit/Debit Cards (Power by Stripe)</label><br>
                                </div>
                                <div class="form-check">
                            ...
                            <p style="display:none;" id="selectedValue_p">You will be charged <span
                                    id="selectedValue"></span>.</p>
                 ...
                 <span class="payment-success"><?= $success ?></span>-->
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 ">
                                        <label class="form-label">Card Number <img class="cards" src="images/cards.png"
                                                alt="hounslow-passport-photoshop-cards" /></label>
                            ...
                            <div class="paypal_method" style="display: none;">
                                <img src="images/paypal.png?ver=<?php echo time();?>" alt="hounslow-passport-photoshop-paypal" />
        ...
        <section class="inner-box-1 showon1 photo_upload_info">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/upload_img1.png" class="card-img-top" alt="hounslow-passport-photoshop-uk-passport-digital-photo">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/upload_img2.png" class="card-img-top" alt="hounslow-passport-photoshop-best-print-passport-photos">
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="images/upload_img3.png" class="card-img-top" alt="hounslow-passport-photoshop-digital-passport-photos">
                        <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="img-container">
                        <img id="image" src="images/blankimg.png" style="max-height:500px;" alt="hounslow-passport-photoshop-passport-photo-online-uk">
                    </div>
                </div>
...
var stripe = Stripe(
    'pk_live_51LD400D9tDbBUl5CcI37wKOB8I0FMQGXZ5yz7GwbuAXf3euBDDdafRUmcPuI1tjlsfJYNxfWJXcMkvn8SBMr66lS00BNiruueT');
...
function stripeTokenHandler(token) {
  ...
  <style>
    .nice-select .option{ white-space: pre;}
    </style>
</html>