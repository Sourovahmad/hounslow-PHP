      ...
      <div class="container-background">
        ...
        <!--div class="containercontact">
				  <form name="message" method="post" enctype="multipart/form-data">
                    ...
                    <div class="imgdiv">
					<img id="blah" src="http://localhost/royal/images/blankimg.png" alt="your image"  />
                    </div>
    ...
    <div class="containercontact">
      ...
      <div class="container">
        ...
        <div class="text-photo">
          <p> <img src="images/checkimg.png" alt="img" width="28px" /> 8 x Passport Photos - 35 mm x 45 mm</p>
          <p> <img src="images/checkimg.png" alt="img" width="28px" />Safer than a Photo Booth Right Now </p>
          <p> <img src="images/checkimg.png" alt="img" width="28px" />Quality Prints. Free & Next Day Delivery</p>
        </div>
      </div>
    </section-->
      <?php
        ...
        if (!!$_FILES['file']['tmp_name']) // is the file uploaded yet?
        {
          ...
          if (in_array(end($info), $allow)) // is this file allowed
          {
            if (move_uploaded_file($_FILES['file']['tmp_name'], $todir . basename($_FILES['file']['name']))) {
              ...
              $mail->Password = 'ldxkhpvbtpjsszcc';                           // SMTP password
        ...
        <div class="help-bg-home">
          <div class="help-left">
            <form name="message" method="post" enctype="multipart/form-data">
              ...
              <label for="pass_visa">f and Visa <span class="required">*</span></label><br>
          ...
          <div class="help-right">
            ...
            <div class="input-group mb-3">
              <input type="file" class="form-control widthcust" name="file" id="inputGroupFile02" required onchange="readURL(this);">
